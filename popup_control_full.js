...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$(divpopup).attr('class', 'quyc3-modal');
			$( "body" ).append(divpopup);
			$("#myModal").html("<a href='http://banhtranmuoitayninh.com' target='_blank'><img src='banhtranmuoitayninh.com/public_html/image/dai-ly-muoi-tay-ninh.jpg' width='500px'/>Đại lý muối Tây Ninh</a> <h2><a class='close-quyc3-modal'>X</a></h2>");
			$('#myModal').quyc3($('#myModal').data());
		}
});